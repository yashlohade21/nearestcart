...
Examples:
  ...
  python db-query-tool.py -q "SELECT * FROM products" --output results.json
    ...
    connection_string = "Host=caboose.proxy.rlwy.net;Port=47067;Database=multiplex-product;Username=postgres;Password=rrptEExxzgJgJgbILKRUlmJmcZNLyVXx;CommandTimeout=120;Maximum Pool Size=100;Minimum Pool Size=10;Connection Idle Lifetime=60;Connection Pruning Interval=10;Pooling=true;Keepalive=15;Tcp Keepalive=true;Tcp Keepalive Time=15;Tcp Keepalive Interval=15;Include Error Detail=true;"
