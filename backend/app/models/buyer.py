...
class Buyer(Base):
    ...
    nave_bills = relationship("NaveBill", back_populates="buyer")
    sale_entries = relationship("SaleEntry", back_populates="buyer")
    sale_payments = relationship("SalePayment", back_populates="buyer")
