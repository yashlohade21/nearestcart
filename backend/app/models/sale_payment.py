...
class SalePayment(Base):
    ...
    received: Mapped[float] = mapped_column(Numeric(14, 2))
    ...
    user = relationship("User", back_populates="sale_payments")
    company = relationship("Company", back_populates="sale_payments")
    buyer = relationship("Buyer", back_populates="sale_payments")
