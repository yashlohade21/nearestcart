...
export default function PaymentVoucherScreen() {
  ...
  const handleSave = async () => {
    if (!farmerId || !amount) {
      Alert.alert(t("error"), "Please select supplier and enter amount");
      return;
    }
    setSaving(true);
    try {
      ...
      Alert.alert(t("error"), e.message || t("failedSavePayment"));
    } finally {
      setSaving(false);
    }
  };
      ...
      >
        ...
        <View style={styles.card}>
          <View style={styles.headerRow}>
            ...
            <Text style={styles.headerTitle}>{t("paymentVoucher")}</Text>
          </View>
          ...
          {amount ? (
            <View style={styles.totalRow}>
              <Text style={styles.totalLabel}>{t("totalPaymentsOut")}</Text>
